...
class TerminalSidebar extends React.Component {
	...
	render() {
		...
		return (
			<div className={`terminal-sidebar ${expanded ? 'expanded' : ''}`}>
				...
				>
					<TabList>
						...
						<Link to="/terminal" className={pathname === "/terminal" ? 'active' : ''} onClick={() => this.closeTab()}>
							<div className="fa fa-line-chart"/>
							<div className="title">Терминал</div>
						</Link>

						<Link to="/cabinet/profile" className={pathname === "/cabinet/profile" ? 'active' : ''} onClick={() => this.closeTab()}>
							<div className="fa fa-user"/>
							<div className="title">Профиль</div>
						</Link>

						<Link to="/cabinet/increase" className={pathname === "/cabinet/increase" ? 'active' : ''} onClick={() => this.closeTab()}>
							<div className="fa fa-credit-card"/>
							<div className="title">Пополнение</div>
						</Link>

						<Link to="/cabinet/output" className={pathname === "/cabinet/output" ? 'active' : ''} onClick={() => this.closeTab()}>
							<div className="fa fa-undo"/>
							<div className="title">Вывод</div>
						</Link>

						<Link to="/cabinet/guide" className={pathname === "/cabinet/guide" ? 'active' : ''} onClick={() => this.closeTab()}>
							<div className="fa fa-graduation-cap"/>
							<div className="title">Обучение</div>
						</Link>

						<Link to="/cabinet/history-deals" className={pathname === "/cabinet/history-deals" ? 'active' : ''} onClick={() => this.closeTab()}>
	...
	tabPanel(title, children = null) {
		...
		return (
			<div style={{height: '100%'}}>
				...
				<div 
					className="fa fa-times tab-panel-close" 
