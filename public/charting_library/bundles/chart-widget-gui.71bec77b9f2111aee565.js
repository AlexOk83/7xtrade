(window.webpackJsonp = window.webpackJsonp || []).push([["chart-widget-gui"], {
    "/NcV": function (t, e) {
        ...
        function o() {
            if (!h) {
                (h = Object(r.a)()).setValue(s(d.getValue("NavigationButtons.visibility"))), h.subscribe(h, function (t) {
        ...
        function n() {
            return [{value: u.VisibleOnMouseOver, title: window.t("Visible on Mouse Over")}, {
                value: u.AlwaysOn,
        ...
        function l() {
            var t, e;
            return c || (c = Object(r.a)(), e = function () {
                var e = t.value();
                e !== u.AlwaysOn && e !== u.AlwaysOff && (e = Modernizr.mobiletouch ? u.AlwaysOn : u.VisibleOnMouseOver), c && c.setValue(e)
            }, (t = o()).subscribe(c, e), e()), c
        }

        var a, r, d, u, h, c;
        i.r(e), i.d(e, "VisibilityType", function () {
            return u
            ...
            return l
        }), i("YFKU"), a = i("bf9a"), r = i("m/cY"), d = i("Vdly"), function (t) {
        ...
        function s(t, e, i, s) {
            ...
            }), (n = document.createElement("div")).classList.add(i), Object(o.isString)(t.icon) ? n.innerHTML = t.icon : n.appendChild(t.icon), l.appendChild(n), l
        }
        ...
        ;!function (t) {
            ...
            var i, s, o;
            for (i = 0, s = [Element.prototype, Document.prototype, DocumentFragment.prototype]; i < s.length; i++) {
                ...
                Object.defineProperty(o, "append", {
                    configurable: !0, enumerable: !0, writable: !0, value: function () {
                        ...
                        if (1 !== l.length) {
                            for (i = document.createDocumentFragment(), s = 0, o = l; s < o.length; s++) n = o[s], i.appendChild(e(n));
                            this.appendChild(i)
        ...
        i.r(e), i.d(e, "ControlBarNavigation", function () {
            ...
            return t.prototype.destroy = function () {
                ...
                0 !== t.length && (this._paneWidth = t[0].width(), this._leftPriceScaleWidth = this._chart.getPriceAxisMaxWidthByName("left"), this._rightPriceScaleWidth = this._chart.getPriceAxisMaxWidthByName("right"), this._updateBtnGroupVisibility())
            }, t.prototype._init = function () {
                var t, e, i = this;
                if (d.CheckMobile.any()) for (t = 0, e = this._btnGroups; t < e.length; t++) e[t].classList.add("js-hidden");
                this._buttons = {
                    ...
                    i._chartModel = i._chart.model(), i._priceAxisChanged = i._chart.getPriceAxisWidthChangedByName(i._priceAxisName),
                        i._resetAvailabilityChanged = i._chartModel.model().isScalesResetAvailableChanged(), i._priceAxisChanged.subscribe(i, i._updateBackBtnPosition), i._resetAvailabilityChanged.subscribe(i, i._updateResetScalesButtonVisibility);
                    var t = i._chart.getResizerDetacher();
                    t.fullscreenable.subscribe(i._boundUpdateMaximizeButtonsVisibility), t.fullscreen.subscribe(i._boundToggleFullscreenButtons), i._updateMaximizeButtonsVisibility(), i._updateBackBtnPosition(), i._back.addEventListener("click", function () {
                        null !== i._chartModel && i._chartModel.timeScale().scrollToRealtime(!0)
                    }), i._checkIntervalId = setInterval(function () {
                        return i._check()
                    }, 1e3), i._chartBackgroundProperty = i._chartModel.model().properties().paneProperties.background, null !== i._chartBackgroundProperty && i._chartBackgroundProperty.subscribe(i, i._updateBgBarStyle), i._updateBgBarStyle()
                })
            }, t.prototype._initHandlers = function () {
                var t, e, i, s = this, o = Modernizr.mobiletouch ? "touchstart" : "mousedown",
                    n = Modernizr.mobiletouch ? ["touchend"] : ["mouseup", "mouseout"];
                for (this._buttons.moveLeft.addEventListener(o, function (t) {
                ...
                }), t = 0, e = n; t < e.length; t++) i = e[t], this._buttons.moveLeft.addEventListener(i, function () {
                ...
                this._buttons.turn.addEventListener("click", function (t) {
                    t.preventDefault(), s._chart.GUIResetScales(), s._trackEvent("Reset to Default Settings")
                }), this._buttons.zoomOut.addEventListener("click", function (t) {
                    t.preventDefault(), null !== s._chartModel && s._chartModel.zoomOut(), s._trackEvent("Zoom Out")
                }), this._buttons.zoomIn.addEventListener("click", function (t) {
                    t.preventDefault(), null !== s._chartModel && s._chartModel.zoomIn(), s._trackEvent("Zoom In")
                }), this._buttons.maximize.addEventListener("click", function (t) {
                    t.preventDefault(), s._chart.setActive(!0), s._chart.getResizerDetacher().requestFullscreen(), s._trackEvent(" Maximize Chart")
                }), this._buttons.minimize.addEventListener("click", function (t) {
                    t.preventDefault(), s._chart.getResizerDetacher().exitFullscreen(), s._trackEvent(" Restore Chart")
                }), this._boundKeydownHandler = this._keydownHandler.bind(this), this._boundKeyupHandler = this._keyupHandler.bind(this), this._parent.ownerDocument.addEventListener("keydown", this._boundKeydownHandler), this._parent.ownerDocument.addEventListener("keyup", this._boundKeyupHandler)
                ...
                return [{
                    ...
                    element: this._getBtnGroup("js-btn-group-zoom"), totalWidth: 86
                }, {
                ...
                if (null !== this._chartModel && this._options.goToRealtime) {
                    ...
                    t !== this._backButtonVisible && (this._backButtonVisible = t, this._back.classList.toggle(A, !this._backButtonVisible))
                }
            }, t.prototype._initVisibility = function () {
                this._visibilityTypeProperty = Object(o.actualBehavior)(), this._visibilityTypeProperty.subscribe(this, this._onVisibilityTypeChange), this._onVisibilityTypeChange()
                ...
                if (null !== this._chartModel) {
                    for (t = Object(a.getLuminance)(this._chartModel.model().properties().paneProperties.background.value()) < .5, e = 0, i = Object.values(this._buttons); e < i.length; e++) i[e].classList.toggle("control-bar__btn--dark", t);
                    this._back.classList.toggle("control-bar__btn--dark", t)
                }
            }, t.prototype._updateBtnGroupVisibility = function () {
                var t, e, i, s = this._leftPriceScaleWidth + this._paneWidth, o = (s + this._rightPriceScaleWidth) / 2,
                    n = Math.min(s - o, o - this._leftPriceScaleWidth), l = 2 * n - 50 - 50, a = !1;
                for (t = 0, e = this._visibilityPrioritizedGroups; t < e.length; t++) (i = e[t]).enoughSpaceForGroup = !1, i.available() && (!H || !i.shouldBeHiddenOnMobile) && (l -= i.totalWidth, i.enoughSpaceForGroup = l >= 0 && !a, a = a || !i.enoughSpaceForGroup),
                !i.enoughSpaceForGroup !== i.element.classList.contains("js-hidden") && i.element.classList.toggle("js-hidden", !i.enoughSpaceForGroup);
                ...
                var t = this._visibilityPrioritizedGroups.reduce(function (t, e) {
                    ...
                    }, 0), e = this._paneWidth + this._leftPriceScaleWidth + this._rightPriceScaleWidth, i = e / 2,
                    s = i - Math.ceil(t / 2);
                ...
                var e, i, s, o = this;
                null !== this._chartModel && "stop" === this._state && this._chartModel.beginUndoMacro(1 === t ? "Move Left" : "Move Right"), this._state = x.stop, this._moveType = "animated", this._deferredFinishTimeout && (clearTimeout(this._deferredFinishTimeout), this._deferredFinishTimeout = 0), this._finishingTimeout && (clearTimeout(this._finishingTimeout), this._finishingTimeout = 0), this._startTime = Date.now(), 0 === this._movingTimeout && (e = this._startTime, i = 10, s = function () {
                    o._moveStep(e, 0, 50 * t, 1e3), o._movingTimeout = setTimeout(s, i)
                }, this._movingTimeout = setTimeout(s, i))
            }, t.prototype._moveStep = function (t, e, i, s) {
                var o, n, l;
                return null === this._chartModel || this._chartModel.timeScale().isEmpty() ? void 0 : ((o = Date.now()) < t && (t = o), ((n = (o - t) / s) > 1 || !isFinite(n)) && (n = 1), l = 1 - Math.pow(1 - n, 3), this._currentDistance = (i - e) * l + e, this._chartModel.scrollChart(this._currentDistance), n)
            }, t.prototype._finishMove = function () {
                var t, e, i, s = this;
                clearTimeout(this._movingTimeout), this._movingTimeout = 0, this._deferredFinishTimeout = 0, t = this._currentDistance, e = Date.now(), i = function () {
                    var o = s._moveStep(e, t, 0, 700);
                    o && o < 1 ? s._finishingTimeout = setTimeout(i, 10) : null !== s._chartModel && (s._state = x.wait_finishing, s._moveType = "", s._movingTimeout = 0, s._currentDistance = 0, s._chartModel.endUndoMacro())
                }, this._finishingTimeout = setTimeout(i, 10)
            }, t.prototype._stopMove = function () {
                "moving" === this._state && (this._state = x.moving, Date.now() - this._startTime < 200 ? this._deferredFinishTimeout = setTimeout(this._finishMove.bind(this), 200 - (Date.now() - this._startTime)) : this._finishMove())
            }, t.prototype._moveByBar = function (t) {
                var e, i, s, o, n, l, a = this;
                if (null !== this._chartModel) {
                    if ((e = this._chartModel.timeScale()).isEmpty()) return;
                    "stop" === this._state && this._chartModel.beginUndoMacro(1 === t ? "Move Left" : "Move Right"), null !== e.visibleBarsStrictRange() && (i = e.indexToCoordinate(e.visibleBarsStrictRange().lastBar()) + e.barSpacing() / 2,
                    Math.abs(e.width() - i) > e.barSpacing() / 6 && this._chartModel.scrollChart(e.width() - i)), this._state = x.stop, this._moveType = "by_bar", this._startTime = Date.now(), this._movingTimeout || (s = 0, o = 150, n = 400, l = function () {
                        a._moveByBarStep(t), s++, o > 100 && (o -= s / 5 * 20), a._movingTimeout = setTimeout(l, o)
                    }, this._movingTimeout = setTimeout(l, n), this._moveByBarStep(t))
                }
                ...
                "moving" === this._state && (clearTimeout(this._movingTimeout), this._movingTimeout = 0, this._state = x.wait_finishing, this._moveType = "", this._movingTimeout = 0, this._currentDistance = 0, null !== this._chartModel && this._chartModel.endUndoMacro())
        ...
        function s(t, e) {
            ...
            return function (t) {
                var e, i, s, o, n, a, r = [];
                t.maximize.visible.value() ? (e = Object(l.ensure)(t.maximize.title), i = Object(l.ensureNotNull)(t.maximize.action), r.push(new p.Action({
                    icon: v,
                    label: e.value(),
                ...
                }))) : t.minimize.visible.value() && (e = Object(l.ensure)(t.minimize.title), s = Object(l.ensureNotNull)(t.minimize.action), r.push(new p.Action({
                    icon: v,
                    label: e.value(),
                ...
                t.up.visible.value() && (e = Object(l.ensure)(t.up.title), o = Object(l.ensureNotNull)(t.up.action), r.push(new p.Action({
                    icon: g,
                    label: e.value(),
                ...
                t.down.visible.value() && (e = Object(l.ensure)(t.down.title), n = Object(l.ensureNotNull)(t.down.action), r.push(new p.Action({
                    icon: m,
                    label: e.value(),
                ...
                t.close.visible.value() && (e = Object(l.ensure)(t.close.title), a = Object(l.ensureNotNull)(t.close.action), r.push(new p.Action({
                    icon: b,
                    label: e.value(),
        ...
        var o, n, l, a, r, d, u, h, c, p, _, b, g, m, v, w, y, f, S, C, E, V, M, T, H, x, A, L, P, B, k, O, D, z, j, W,
            N, R, I;
        i.r(e), o = i("1ANp"), n = i("3ClC"), i("H72D"), l = i("Eyy1"), a = i("Zo2/"), r = i("EV8o"), d = i("ZKFq"), u = i("0jws"), h = 666.65, c = function () {
            function t(t, e, i) {
                var s, o, n, l, r, u, h;
                for (this._parentEl = document.createElement("div"), this._listActionsWrapperEl = null, this._listActionsElements = {}, this._actionsSpawns = {}, this._onToggleVisibilityHandler = null, this._wrapEl = t, this._actions = e, this._globalVisibility = i.globalVisibility.spawn(), this._globalVisibility.subscribe(this._setVisibility.bind(this)), this._visibilityType = i.visibilityType.spawn(), this._visibilityType.subscribe(this._updateVisibilityActions.bind(this)), this._hasTopMargin = i.hasTopMargin.spawn(), this._hasTopMargin.subscribe(this._updateTopMargin.bind(this)), this._doNotSwitchToContextMenuMode = i.doNotSwitchToContextMenuMode, this._themedColor = i.themedColor.spawn(), this._themedColor.subscribe(this._updateThemedColor.bind(this)), s = 0, o = Object.entries(this._actions); s < o.length; s++) l = (n = o[s])[0], r = n[1], u = l, this._actionsSpawns[u] = {
                    visible: r.visible.spawn(),
                    title: void 0 === r.title ? null : r.title.spawn()
                },
                    this._actionsSpawns[u].visible.subscribe(this._updateActionVisibilities.bind(this, u)), null !== (h = this._actionsSpawns[u].title) && h.subscribe(this._updateActionTitle.bind(this, u));
                this._render(), this._updateVisibilityActions(this._visibilityType.value()), this._updateTopMargin(this._hasTopMargin.value()), this._updateThemedColor(this._themedColor.value()), this._parentEl.classList.toggle(d.touchMode, a.trackingModeIsAvailable), this._parentEl.addEventListener("contextmenu", function (t) {
            ...
            return t.prototype.destroy = function () {
                var t, e, i, s;
                for (this._visibilityType.destroy(), this._hasTopMargin.destroy(), this._themedColor.destroy(), t = 0, e = Object.keys(this._actionsSpawns); t < e.length; t++) i = e[t], this._actionsSpawns[i].visible.destroy(), null !== (s = this._actionsSpawns[i].title) && s.destroy();
                null !== this._onToggleVisibilityHandler && (this._wrapEl.removeEventListener("mouseenter", this._onToggleVisibilityHandler), this._wrapEl.removeEventListener("mouseleave", this._onToggleVisibilityHandler), this._onToggleVisibilityHandler = null), this._parentEl.innerHTML = "", delete this._parentEl
            }, t.prototype.updateWidgetModeByWidth = function (t) {
                var e, i, s = t < h;
                this._doNotSwitchToContextMenuMode.value() && s && (s = !1), e = Object(l.ensureNotNull)(this._listActionsWrapperEl), i = Object(l.ensureNotNull)(this._listActionsElements.more), e.classList.toggle(u.blockHidden, s), i.classList.toggle(u.blockHidden, !s || !this._actions.more.visible.value())
                ...
                null === this._listActionsWrapperEl && (this._listActionsWrapperEl = document.createElement("div"), this._listActionsWrapperEl.classList.add(d.buttonsWrapper), this._parentEl.append(this._listActionsWrapperEl)), this._listActionsElements.up = Object(r.a)(this._actions.up, d.button, d.buttonIcon, u.blockHidden), this._listActionsElements.down = Object(r.a)(this._actions.down, d.button, d.buttonIcon, u.blockHidden), this._listActionsElements.close = Object(r.a)(this._actions.close, d.button, d.buttonIcon, u.blockHidden), this._listActionsElements.maximize = Object(r.a)(this._actions.maximize, d.button, d.buttonIcon, u.blockHidden), this._listActionsElements.minimize = Object(r.a)(this._actions.minimize, d.button, d.buttonIcon, u.blockHidden), this._listActionsWrapperEl.append(this._listActionsElements.up, this._listActionsElements.down, this._listActionsElements.close, this._listActionsElements.maximize, this._listActionsElements.minimize), this._listActionsElements.more = Object(r.a)(this._actions.more, d.button, d.buttonIcon, u.blockHidden), this._parentEl.append(this._listActionsElements.more)
            }, t.prototype._updateActionVisibilities = function (t, e) {
                Object(l.ensureNotNull)(this._listActionsElements[t]).classList.toggle(u.blockHidden, !e)
            }, t.prototype._updateActionTitle = function (t, e) {
                Object(l.ensureNotNull)(this._listActionsElements[t]).setAttribute("title", e)
            }, t.prototype._updateVisibilityActions = function (t) {
                var e = t === o.VisibilityType.AlwaysOn, i = !1
                ;t === o.VisibilityType.AlwaysOff || e ? (null !== this._onToggleVisibilityHandler && (this._wrapEl.removeEventListener("mouseenter", this._onToggleVisibilityHandler), this._wrapEl.removeEventListener("mouseleave", this._onToggleVisibilityHandler), this._onToggleVisibilityHandler = null), i = e) : null === this._onToggleVisibilityHandler && (this._onToggleVisibilityHandler = this._onToggleButtonsVisibility.bind(this), this._wrapEl.addEventListener("mouseenter", this._onToggleVisibilityHandler), this._wrapEl.addEventListener("mouseleave", this._onToggleVisibilityHandler)), this._setVisibility(this._globalVisibility.value() && i)
            }, t.prototype._onToggleButtonsVisibility = function (t) {
                this._setVisibility(this._globalVisibility.value() && "mouseenter" === t.type)
        ...
        }(), p = i("7KDR"), _ = i("5VQP"), b = i("obM5"), g = i("fk9O"), m = i("gKdq"), v = i("WYzw"), w = window.t("Double click"), y = i("hY0g"), f = i.n(y), S = i("EsvI"), C = i("ei7k"), E = i("OJSF"), V = i("PXSR"), M = i("QEZv"), T = i("ku84"), H = i("i9xP"), x = i("1Wf8"), A = i("956S"), i.d(e, "PaneControlsWidget", function () {
            return I
        }), L = Modernizr.mobiletouch, P = L ? x : T, B = L ? A : H, k = window.t("Delete pane"), O = window.t("Move pane up"), D = window.t("Move pane down"), z = window.t("Maximize pane"), j = window.t("Restore pane"), W = window.t("Manage panes"), N = window.t("Double click"), R = Object(C.b)({
            keys: [""],
            text: N
        }), I = function () {
            function t(t, e, i, s, n) {
                var l = this;
                this._actions = {}, this._moreActionCM = null, this._themedColor = new f.a(""), this._model = t, this._paneWidget = e, this._callbacks = s, this._closeButtonVisibility = new f.a(this._getCloseButtonVisibility()), this._upButtonVisibility = new f.a(this._getUpButtonVisibility()), this._downButtonVisibility = new f.a(this._getDownButtonVisibility()), this._maximizeButtonVisibility = new f.a(this._getMaximizeButtonVisibility()), this._minimizeButtonVisibility = new f.a(this._getMinimizeButtonVisibility()), this._createActions(), this._visibilityTypeProperty = Object(o.actualBehavior)(), this._visibilityTypeProperty.subscribe(this, function (t) {
                    l._visibilityType.setValue(t.value())
                }), this._visibilityType = new f.a(this._visibilityTypeProperty.value()), this._isPaneFirst = new f.a(this._getIsPaneFirstValue()), this._isPaneMaximize = new f.a(this._getIsPaneMaximizeValue()), this._isWidgetShow = new f.a(this._getIsWidgetShow()), this._backgroundThemeName = i.backgroundThemeName, this._renderer = new c(n, this._actions, {
            ...
            return t.prototype.destroy = function () {
                ...
                this._updateButtonsVisibility(), this._isPaneFirst.setValue(this._getIsPaneFirstValue()),
                    this._isPaneMaximize.setValue(this._getIsPaneMaximizeValue()), this._isWidgetShow.setValue(this._getIsWidgetShow())
            }, t.prototype.updateWidgetModeByWidth = function (t) {
                this._renderer.updateWidgetModeByWidth(t)
            }, t.prototype.updateThemedColors = function (t) {
                null === t && (t = Object(S.getStdThemedValue)("chartProperties.paneProperties.background", this._backgroundThemeName.value())), this._themedColor.setValue(t || "")
                ...
                return t.containsMainSeries() || t.isMaximized() || L || (e = t.dataSources().some(function (t) {
                ...
                var t = this._paneWidget.state(), e = this._model.model().panes().indexOf(t);
                return e > 0 && !t.isMaximized() && !L
            }, t.prototype._getDownButtonVisibility = function () {
                var t = this._paneWidget.state(), e = this._model.model().panes(), i = e.indexOf(t);
                ...
                var e = this;
                t.preventDefault(), null !== this._moreActionCM && this._moreActionCM.isShown() ? this._moreActionCM = null : s(this._actions, t).then(function (t) {
                    e._moreActionCM = t
                })
        ...
        function l(t, e, i, s, o) {
            return function (t, e, i, s) {
                var o = [], l = t.model().properties().paneProperties.legendProperties;
                o.push(new Vt.Action({
                    checkable: !0,
                    checked: l.showSeriesTitle.value(),
                    label: Ht,
                    statName: "Show Symbol",
                    onExecute: function () {
                        return n(t, l.showSeriesTitle, "Change Symbol Description Visibility")
                    }
                })), o.push(new Vt.Action({
                    checkable: !0,
                    ...
                    onExecute: function () {
                        return n(t, l.showSeriesOHLC, "Change OHLC Values Visibility")
                    }
                })), o.push(new Vt.Action({
                    checkable: !0,
                ...
                })), o.push(new Vt.Separator), o.push(new Vt.Action({
                    checkable: !0,
                    checked: l.showStudyTitles.value(),
                    label: Lt,
                    statName: "Show Indicator Titles",
                    onExecute: function () {
                        return n(t, l.showStudyTitles, "Change Indicator Titles Visibility")
                    }
                })), o.push(new Vt.Action({
                    checkable: !0,
                    ...
                    onExecute: function () {
                        return n(t, l.showStudyArguments, "Change Indicator Arguments Visibility")
                    }
                })), o.push(new Vt.Action({
                    checkable: !0,
                    ...
                    onExecute: function () {
                        return n(t, l.showStudyValues, "Change Indicator Values Visibility")
                    }
                })), Ot || (o.push(new Vt.Separator), o.push(new Vt.Action({
                    checkable: !0,
                    checked: l.wrapText.value(),
                    label: kt,
                    statName: "Wrap Text",
                    onExecute: function () {
                        n(t, l.wrapText, "Change wrap text"), a("Change wrap text " + (l.wrapText ? "on" : "off"))
                    }
                })));
                e.settings && (o.push(new Vt.Separator), o.push(new Vt.Action({
        ...
        var r, d, u, h, c, p, _, b, g, m, v, w, y, f, S, C, E, V, M, T, H, x, A, L, P, B, k, O, D, z, j, W, N, R, I, F,
            G, K, Z, q, Y, U, J, X, Q, $, tt, et, it, st, ot, nt, lt, at, rt, dt, ut, ht, ct, pt, _t, bt, gt, mt, vt,
            wt, yt, ft, St, Ct, Et, Vt, Mt, Tt, Ht, xt, At, Lt, Pt, Bt, kt, Ot, Dt, zt, jt, Wt, Nt, Rt, It, Ft, Gt;
        i.r(e), r = i("mrSG"), d = i("eJTA"), u = i("Eyy1"), i("H72D"), h = i("efOF"), c = i("EV8o"), p = i("S8xo"), _ = i("GUQs"), b = i("R5JZ"), g = i("5Alx"), m = i("0jws"), v = i("qFKp"), w = v.CheckMobile.any(), y = [g.title1st, g.title2nd, g.title3rd, g.title4th], f = 24, C = function (t) {
            function e(e, i, s) {
                var o = t.call(this, e, i, s) || this;
                return o._clientHeight = null, o._flagged = o._model.flagged().spawn(), o._flagged.subscribe(o._updateFlaggedState.bind(o)), o._updateStates(), o
            }

            return Object(r.__extends)(e, t), e.prototype.destroy = function () {
                ...
                var e, i, s;
                t.prototype._render.call(this), this._el = document.createElement("div"), this._el.classList.add(g.item, g.series), this._el.dataset.name = "legend-series-item", (e = document.createElement("div")).classList.add(g.noWrapWrapper), this._el.appendChild(e), i = Object(u.ensureNotNull)(this._titleParentEl), e.appendChild(i), null !== this._actionsParentEl && e.appendChild(this._actionsParentEl), s = Object(u.ensureNotNull)(this._valuesParentEl), this._el.appendChild(s), this._parentEl.append(this._el)
                ...
                var t, e, i, s, o, n, l, a
                ;
                for (null === this._valuesParentEl && (this._valuesParentEl = document.createElement("div"), this._valuesParentEl.classList.add(g.valuesWrapper), this._valuesAdditionalWrapperEl = document.createElement("div"), this._valuesAdditionalWrapperEl.classList.add(g.valuesAdditionalWrapper), this._valuesParentEl.appendChild(this._valuesAdditionalWrapperEl)), t = Object(u.ensureNotNull)(this._valuesAdditionalWrapperEl), e = 0, i = this._values.value(); e < i.length; e++) s = i[e], (o = document.createElement("div")).classList.add(g.valueItem), o.classList.toggle(m.blockHidden, !s.visible.value()), n = document.createElement("div"), l = s.title.value() || "", n.classList.add(g.valueTitle), n.classList.toggle(m.blockHidden, 0 === l.length), n.appendChild(document.createTextNode(l)), o.appendChild(n), (a = document.createElement("div")).classList.add(g.valueValue), a.style.color = s.color.value() || "", a.appendChild(document.createTextNode(s.value.value())), o.appendChild(a), this._valuesElements.push({value: a}), t.appendChild(o)
            }, e.prototype._updateFlaggedState = function () {
                void 0 !== this._flagged && Object(u.ensureNotNull)(this._el).classList.toggle(g.flagged, Boolean(this._flagged.value()))
            }, e
        }(S = function () {
            function t(t, e, i) {
                var s, o;
                for (this._el = null, this._titleParentEl = null, this._titleElements = [], this._valuesParentEl = null, this._valuesAdditionalWrapperEl = null, this._valuesElements = [], this._actionsParentEl = null, this._actionAdditionalWrapperEl = null, this._showActionsHandler = null, this._hideActionsHandler = null, this._selectedSourceHandler = null, this._mouseEventHandlers = [], this._stayInHoveredMode = !1, this._outsideEvent = null, this._model = t, this._parentEl = e, this._disabled = this._model.disabled().spawn(), this._disabled.subscribe(this._updateDisabledState.bind(this)), this._selected = this._model.selected().spawn(), this._selected.subscribe(this._updateSelectedState.bind(this)), this._isTitleHidden = this._model.isTitleHidden().spawn(), this._isValuesHidden = this._model.isValuesHidden().spawn(), this._isRowHidden = this._model.isRowHidden().spawn(), this._isTitleHidden.subscribe(this._updateShowTitles.bind(this)), this._isValuesHidden.subscribe(this._updateShowValues.bind(this)), this._isRowHidden.subscribe(this._updateShowLine.bind(this)), this._titlesSpawns = this._model.titles().map(function (t) {
                    return t.spawn()
                }), s = 0; s < this._titlesSpawns.length; s++) this._titlesSpawns[s].subscribe(this._updateTitlesHandler.bind(this, s));
                for (this._values = this._model.values().spawn(), this._values.subscribe(this._updateValues.bind(this)), this._valuesSpawnArray = this._values.value().map(function (t) {
                    return {value: t.value.spawn(), color: t.color.spawn(), visible: t.visible.spawn()}
                }), this._addValuesSpawnsSubscriptions(), this._actionsSpawnArray = this._model.actions().map(function (t) {
                    return {visible: t.visible.spawn(), title: void 0 === t.title ? null : t.title.spawn()}
                }), s = 0; s < this._actionsSpawnArray.length; s++) this._actionsSpawnArray[s].visible.subscribe(this._updateActionVisibilities.bind(this, s)), null !== (o = this._actionsSpawnArray[s].title) && o.subscribe(this._updateActionTitle.bind(this, s));
                this._withActions = i.withActions, this._render(), this._updateStates(),
                    this._updateShowTitles(), this._updateShowValues(), this._updateShowLine(), this._customTextColor = i.customTextColor.spawn(), this._customTextColor.subscribe(this._updateCustomTextColor.bind(this)), this._updateCustomTextColor(), this._withActions && (this._showActionsHandler = Object(_.b)(this._showActions.bind(this)), this._hideActionsHandler = Object(_.b)(this._hideActions.bind(this)), this._selectedSourceHandler = Object(_.b)(this._model.setSourceSelected.bind(this._model)), null !== this._titleParentEl && (this._titleParentEl.addEventListener("touchend", this._selectedSourceHandler), this._titleParentEl.addEventListener("mousedown", this._selectedSourceHandler), w || (this._titleParentEl.addEventListener("mouseenter", this._showActionsHandler), this._titleParentEl.addEventListener("mouseleave", this._hideActionsHandler)), this._mouseEventHandlers.push(new p.MouseEventHandler(this._titleParentEl, {contextMenuEvent: this._onShowContextMenuAndStayInHoveredMode.bind(this)}, {
                    treatVertTouchDragAsPageScroll: !1,
                    treatHorzTouchDragAsPageScroll: !1
                })), this._mouseEventHandlers.push(new p.MouseEventHandler(this._titleParentEl, {mouseDoubleClickEvent: this._model.onShowSettings.bind(this._model)}, {
                    treatVertTouchDragAsPageScroll: !1,
                    treatHorzTouchDragAsPageScroll: !1
                }))), null === this._actionAdditionalWrapperEl || w || (this._actionAdditionalWrapperEl.addEventListener("mouseenter", this._showActionsHandler), this._actionAdditionalWrapperEl.addEventListener("mouseleave", this._hideActionsHandler)), null !== this._valuesParentEl && this._mouseEventHandlers.push(new p.MouseEventHandler(this._valuesParentEl, {contextMenuEvent: this._model.onContextMenuShow.bind(this._model)}, {
                    treatVertTouchDragAsPageScroll: !1,
                    treatHorzTouchDragAsPageScroll: !1
                })))
            }
            ...
            return t.prototype.destroy = function () {
                var t, e, i, s, o, n, l, a;
                for (this._disabled.destroy(), this._selected.destroy(), this._isTitleHidden.destroy(), this._isValuesHidden.destroy(), this._isRowHidden.destroy(), this._customTextColor.destroy(), t = 0, e = this._titlesSpawns; t < e.length; t++) e[t].destroy();
                if (null !== this._titleParentEl) {
                    for (i = 0, s = this._mouseEventHandlers; i < s.length; i++) s[i].destroy();
                ...
                for (o = 0, n = this._actionsSpawnArray; o < n.length; o++) (l = n[o]).visible.destroy(), null !== (a = l.title) && a.destroy();
                null !== this._actionAdditionalWrapperEl && (this._withActions && null !== this._showActionsHandler && null !== this._hideActionsHandler && !w && (this._actionAdditionalWrapperEl.removeEventListener("mouseenter", this._showActionsHandler), this._actionAdditionalWrapperEl.removeEventListener("mouseleave", this._hideActionsHandler)), this._actionAdditionalWrapperEl = null),
                    this._actionsParentEl = null, this._removeValuesSpawnsSubscriptions(), this._values.destroy(), null !== this._valuesParentEl && (this._valuesElements = [], this._valuesParentEl = null), null !== this._el && (Object(u.ensureNotNull)(this._el.parentNode).removeChild(this._el), this._el = null)
                ...
                s(Object(u.ensure)(this._valuesElements[t].value), e), this._updateShowValues()
            }, t.prototype._updateValueColorHandler = function (t, e) {
                void 0 === e && (e = ""), Object(u.ensure)(this._valuesElements[t].value).style.color = e
            }, t.prototype._updateValueVisibleHandler = function (t, e) {
                var i = Object(u.ensure)(this._valuesElements[t].value), s = i.closest("." + g.valueItem);
                null !== s && s.classList.toggle(m.blockHidden, !e)
            }, t.prototype._updateDisabledState = function () {
                null !== this._el && this._el.classList.toggle(g.disabled, this._disabled.value())
                ...
                null !== this._el && this._withActions && this._el.classList.toggle(g.selected, this._selected.value())
                ...
                null !== this._el && this._withActions && !this._stayInHoveredMode && (this._el.classList.remove(g.withAction), null !== this._valuesParentEl && this._valuesParentEl.classList.remove(g.withTail))
                ...
                if (null !== this._valuesAdditionalWrapperEl) {
                    ...
                    }), this._valuesAdditionalWrapperEl.classList.toggle(m.blockHidden, t)
                }
            }, t.prototype._updateValues = function () {
                this._removeValuesSpawnsSubscriptions(), null !== this._valuesParentEl && null !== this._valuesAdditionalWrapperEl && (this._valuesElements = [], this._valuesAdditionalWrapperEl.innerHTML = ""), this._valuesSpawnArray = this._values.value().map(function (t) {
                    return {value: t.value.spawn(), color: t.color.spawn(), visible: t.visible.spawn()}
                }), this._renderValues(), this._addValuesSpawnsSubscriptions(), this._updateShowValues()
            }, t.prototype._removeValuesSpawnsSubscriptions = function () {
                var t, e, i;
                for (t = 0, e = this._valuesSpawnArray; t < e.length; t++) (i = e[t]).value.destroy(), i.color.destroy(), i.visible.destroy();
                this._valuesSpawnArray = []
            }, t.prototype._addValuesSpawnsSubscriptions = function () {
                var t, e;
                for (t = 0; t < this._valuesSpawnArray.length; t++) (e = this._valuesSpawnArray[t]).value.subscribe(this._updateValuesHTMLElHandler.bind(this, t)), e.color.subscribe(this._updateValueColorHandler.bind(this, t)), e.visible.subscribe(this._updateValueVisibleHandler.bind(this, t))
            }, t.prototype._updateActionVisibilities = function (t) {
                null !== this._actionsParentEl && this._actionsParentEl.querySelectorAll("." + g.button)[t].classList.toggle(m.blockHidden, !this._actionsSpawnArray[t].visible.value())
            }, t.prototype._updateActionTitle = function (t) {
                var e = this._actionsSpawnArray[t].title;
                null !== this._actionsParentEl && null !== e && this._actionsParentEl.querySelectorAll("." + g.button)[t].setAttribute("title", e.value())
            }, t.prototype._updateCustomTextColor = function () {
                var t, e, i, s, o, n = this._customTextColor.value() || null;
                for (t = 0, e = this._titleElements; t < e.length; t++) null !== (i = e[t]) && (i.style.color = n);
                for (s = Object(u.ensureNotNull)(this._valuesParentEl).querySelectorAll("." + g.valueTitle), o = 0; o < s.length; o++) s[o].style.color = n;
                Object(u.ensureNotNull)(this._el).classList.toggle(g.withCustomTextColor, Boolean(n))
            }, t.prototype._onShowContextMenuAndStayInHoveredMode = function (t) {
                var e = this;
                this._addOutsideEventForCancelHoveredMode(), this._model.onContextMenuShow(t, function () {
                    e._updateHoveredState(!1)
                }).then(function (t) {
                    null !== t && e._updateHoveredState(!0)
                })
            }, t.prototype._cancelHoveredMode = function () {
                this._updateHoveredState(!1), null !== this._outsideEvent && (this._outsideEvent(), this._outsideEvent = null)
                ...
                null !== this._outsideEvent && this._outsideEvent(), this._outsideEvent = Object(b.a)(new h.CustomEvent("timestamp").timeStamp, this._el, this._cancelHoveredModeAndHide.bind(this), window.document, {mouseDown: !0})
            }, t.prototype._updateHoveredState = function (t) {
                null !== this._el && (this._stayInHoveredMode = t, this._el.classList.toggle(g.stayInHoveredMode, t))
            }, t
        }()), E = i("fBig"), V = function () {
            function t(t) {
                this._loadingEl = null, this._parentEl = t, this._renderLoading()
            }

            return t.prototype.toggleVisibility = function (t) {
                null !== this._loadingEl && this._loadingEl.classList.toggle(E.shown, t)
            }, t.prototype._renderLoading = function () {
                this._loadingEl = document.createElement("span"), this._loadingEl.classList.add(E.loader), this._loadingEl.innerHTML = '\n\t\t\t<span class="' + E.loaderItem + '"></span>\n\t\t\t<span class="' + E.loaderItem + '"></span>\n\t\t\t<span class="' + E.loaderItem + '"></span>\n\t\t', this._parentEl.appendChild(this._loadingEl)
            }, t
        }(), M = i("JOqt"), T = "tempDisabled", H = function (t) {
            function e(e, i, s) {
                var o = t.call(this, e, i, s) || this;
                return o._disableTimeout = null, o._loader = null, null !== o._valuesParentEl && (o._loader = new V(o._valuesParentEl)), o._globalRowVisibility = o._model.globalVisibility().spawn(), o._globalRowVisibility.subscribe(o._updateShowLine.bind(o)), o._error = o._model.error().spawn(), o._error.subscribe(o._updateErrorState.bind(o)), o._loading = o._model.loading().spawn(), o._loading.subscribe(Object(M.debounce)(o._updateLoadingState.bind(o), 500)), o._has5Buttons = o._model.isPineScriptDataSource().spawn(), o._has5Buttons.subscribe(o._update5ButtonsStyles.bind(o)), o._updateStates(!o._disabled.value()), o
            }

            return Object(r.__extends)(e, t), e.prototype.destroy = function () {
                t.prototype.destroy.call(this), null !== this._disableTimeout && clearTimeout(this._disableTimeout), void 0 !== this._error && this._error.destroy(), void 0 !== this._loading && this._loading.destroy(), this._has5Buttons.destroy(), this._globalRowVisibility && this._globalRowVisibility.destroy()
                ...
                if (null !== this._el && void 0 !== this._globalRowVisibility) {
                    ...
                    e ? this._el.classList.toggle(m.blockHidden, e) : t.prototype._updateShowLine.call(this)
                }
            }, e.prototype._render = function () {
                var e, i;
                t.prototype._render.call(this), this._el = document.createElement("div"), this._el.classList.add(g.item, g.study), this._el.dataset.name = "legend-source-item", e = Object(u.ensureNotNull)(this._titleParentEl), this._el.appendChild(e), null !== this._actionsParentEl && this._el.appendChild(this._actionsParentEl), i = Object(u.ensureNotNull)(this._valuesParentEl), this._el.appendChild(i), this._parentEl.append(this._el)
            }, e.prototype._renderValues = function () {
                var t, e, i, s, o, n;
                for (null === this._valuesParentEl && (this._valuesParentEl = document.createElement("div"), this._valuesParentEl.classList.add(g.valuesWrapper), this._valuesAdditionalWrapperEl = document.createElement("div"), this._valuesAdditionalWrapperEl.classList.add(g.valuesAdditionalWrapper), this._valuesParentEl.appendChild(this._valuesAdditionalWrapperEl)), t = Object(u.ensureNotNull)(this._valuesAdditionalWrapperEl), e = 0,
                         i = this._values.value(); e < i.length; e++) s = i[e], (o = document.createElement("div")).classList.add(g.valueItem), o.classList.toggle(m.blockHidden, !s.visible.value()), (n = document.createElement("div")).classList.add(g.valueValue), n.style.color = s.color.value() || "", n.appendChild(document.createTextNode(s.value.value())), o.appendChild(n), this._valuesElements.push({value: n}), t.appendChild(o)
            }, e.prototype._updateStates = function (e) {
                t.prototype._updateStates.call(this), e && this._clearDisableState(), this._updateErrorState(), this._updateLoadingState()
            }, e.prototype._updateDisabledState = function () {
                var t = this;
                null !== this._el && (null !== this._disableTimeout && (clearTimeout(this._disableTimeout), this._disableTimeout = null, this._el.classList.remove(T), this._el.classList.remove(g.hiddenLoading)), this._disabled.value() ? this._el.classList.add(g.disabled) : (this._el.classList.add(T), this._el.classList.add(g.hiddenLoading), this._disableTimeout = setTimeout(function () {
                    null !== t._el && void 0 !== t._loading && !t._loading.value() && t._el.classList.contains(T) && (t._el.classList.remove(T), t._el.classList.remove(g.hiddenLoading), t._el.classList.toggle(g.disabled, t._disabled.value()))
                }, 1e3)))
            }, e.prototype._updateErrorState = function () {
                void 0 !== this._error && void 0 !== this._error.value() && Object(u.ensureNotNull)(this._el).classList.toggle(g.error, this._error.value())
            }, e.prototype._updateLoadingState = function () {
                if (void 0 !== this._loading && void 0 !== this._loading.value() && null !== this._el) {
                    this._el.classList.contains(T) && (this._loading.value() ? this._el.classList.add(g.hiddenLoading) : this._clearDisableState());
                    var t = Boolean(this._loading.value());
                    this._el.classList.toggle(g.loading, t), null !== this._loader && this._loader.toggleVisibility(t)
                }
            }, e.prototype._clearDisableState = function () {
                null !== this._el && (this._el.classList.remove(g.hiddenLoading), this._el.classList.remove(g.disabled), this._el.classList.remove(T))
            }, e.prototype._update5ButtonsStyles = function (t) {
                null !== this._el && this._el.classList.toggle(g.has5Buttons, t)
            }, e
        }(S), x = i("Zo2/"), A = i("6dGu"), L = i("rGGD"), P = i("Y+EN"), B = i("vYP1"), k = window.t("Hide Indicator Legend"), O = window.t("Show Indicator Legend"), D = window.t("Show Object Tree"), z = function () {
            function t(t, e, i) {
                this._el = null, this._counterEl = null, this._arrowIconEL = null, this._objectTreeEl = null, this._mode = 0, this._parentEl = t, this._themedColor = e.spawn(), this._themedColor.subscribe(this._updateThemedColor.bind(this)), this._sourceCount = i.visibleDataSourceCount.spawn(), this._sourceCount.subscribe(this._updateSourceCount.bind(this)), this._isStateOpen = i.isDataSourcesCollapsed.spawn(), this._isStateOpen.subscribe(this._updateState.bind(this)), this._showObjectsTree = i.showObjectsTree.spawn(), this._showObjectsTree.subscribe(this._updateObjectTreeVisibility.bind(this)), this._render(), this._updateState(), this._updateThemedColor(this._themedColor.value()), this._updateObjectTreeVisibility(this._showObjectsTree.value()), this._toggleStateHandler = Object(_.b)(i.onCollapseDataSources), this._showObjectTreeHandler = Object(_.b)(i.onShowObjectsTreeDialog),
            ...
            return t.prototype.destroy = function () {
                this._sourceCount.destroy(), this._isStateOpen.destroy(), null !== this._objectTreeEl && (this._objectTreeEl.removeEventListener("touchend", this._showObjectTreeHandler), this._objectTreeEl.removeEventListener("mousedown", this._showObjectTreeHandler), this._objectTreeEl = null), this._arrowIconEL = null, this._counterEl = null, null !== this._el && (this._el.removeEventListener("touchend", this._toggleStateHandler), this._el.removeEventListener("mousedown", this._toggleStateHandler), this._el.innerHTML = "", this._el = null)
            }, t.prototype.setMode = function (t) {
                this._mode = t ? 1 : 0, this._updateTooltip()
            }, t.prototype._render = function () {
                this._el = document.createElement("div"), this._el.className = g.toggler + " apply-common-tooltip", this._arrowIconEL = document.createElement("div"), this._arrowIconEL.classList.add(g.iconArrow), this._arrowIconEL.innerHTML = x.trackingModeIsAvailable ? L : A, this._el.appendChild(this._arrowIconEL), this._objectTreeEl = document.createElement("div"), this._objectTreeEl.classList.add(g.objectTree), this._objectTreeEl.innerHTML = x.trackingModeIsAvailable ? B : P, this._el.appendChild(this._objectTreeEl), this._counterEl = document.createElement("div"), this._counterEl.classList.add(g.counter), this._counterEl.appendChild(document.createTextNode(String(this._sourceCount.value()))), this._el.appendChild(this._counterEl), this._parentEl.appendChild(this._el)
            }, t.prototype._updateThemedColor = function (t) {
                null !== this._el && (this._el.style.backgroundColor = t)
            }, t.prototype._updateSourceCount = function (t) {
                s(Object(u.ensureNotNull)(this._counterEl), String(t)), this._updateCounterVisibility(t)
                ...
                this._parentEl.classList.toggle(g.closed, t), this._updateTooltip(), a((t ? "Hide" : "Show") + " not main sources")
                ...
                null !== this._objectTreeEl && this._objectTreeEl.classList.toggle(m.blockHidden, !t)
            }, t
        }(), j = i("glKZ"), W = function () {
            function t(t, e) {
            ...
            return t.prototype.destroy = function () {
                var t, e;
                if (this._isStudiesLegendHidden.destroy(), this._isAllLegendHidden.destroy(), this._themedColor.destroy(), this._showBackground.destroy(), this._backgroundTransparency.destroy(), this._collapsedDataSourcesCountSpawn.destroy(), x.trackingModeIsAvailable && null !== this._collapsedDataSourcesWrapperEl && this._collapsedDataSourcesWrapperEl.removeEventListener("touchend", this._showCollapsedDataSourcesTooltipHandler), this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(), null !== this._wrapText && this._wrapText.destroy(), null !== this._dataSourcesAdditionalWrapperEl && (this._dataSourcesAdditionalWrapperEl.innerHTML = "", this._dataSourcesAdditionalWrapperEl = null), null !== this._dataSourcesEl && (this._dataSourcesEl.innerHTML = "", this._dataSourcesEl = null), null !== this._renderToggler && (this._renderToggler.destroy(), this._renderToggler = null), null !== this._mainDataSourceRenderer && (this._mainDataSourceRenderer.destroy(), this._mainDataSourceRenderer = null), 0 !== this._dataSourceRenderers.length) {
                    for (t = 0, e = this._dataSourceRenderers; t < e.length; t++) e[t].destroy();
                    this._dataSourceRenderers = []
                }
                this._parentEl.innerHTML = "", delete this._parentEl
            }, t.prototype.addMainDataSource = function (t) {
                var e, i = this;
                null === this._mainDataSourceRenderer && (e = document.createDocumentFragment(), this._mainDataSourceRenderer = new C(t, e, {
                    withActions: this._options.withActions,
                    customTextColor: this._options.customTextColor
                }), this._parentEl.insertBefore(e, this._dataSourcesEl), this._updateLegendVisibility()), t.onDestroy().subscribe(this, function () {
                ...
                var e, i, s, o, n, l = this
                ;
                for (null === this._dataSourcesEl && (this._dataSourcesEl = document.createElement("div"), this._dataSourcesEl.classList.add(g.sourcesWrapper), this._renderToggle(this._dataSourcesEl), this._dataSourcesAdditionalWrapperEl = document.createElement("div"), this._dataSourcesAdditionalWrapperEl.classList.add(g.sources), this._dataSourcesEl.appendChild(this._dataSourcesAdditionalWrapperEl), this._renderCollapsedCounter(this._dataSourcesAdditionalWrapperEl), this._parentEl.appendChild(this._dataSourcesEl)), e = Object(u.ensureNotNull)(this._dataSourcesAdditionalWrapperEl), i = function (t) {
                    var i = new H(t, e, {
                        withActions: s._options.withActions,
                        customTextColor: s._options.customTextColor
                    });
                    s._dataSourceRenderers.push(i), s._updateLegendVisibility(), t.onDestroy().subscribe(s, function () {
                        var t = l._dataSourceRenderers.indexOf(i);
                        -1 !== t && (l._dataSourceRenderers[t].destroy(), l._dataSourceRenderers.splice(t, 1))
                    }, !0)
                }, s = this, o = 0, n = t; o < n.length; o++) i(n[o])
                ...
                var e = t < 213, i = t < 120;
                this._parentEl.classList.toggle(g.minimized, e && !i), this._parentEl.classList.toggle(g.micro, i), null !== this._renderToggler && this._renderToggler.setMode(i)
                ...
                this._options.showToggleButton && (this._renderToggler = new z(t, this._options.themedColor, this._togglerOptions))
                ...
                Object(j.showOnElement)(this._collapsedDataSourcesEl, {text: this._options.collapsedDataSourcesTitle.value()}), this._addOutsideEventForHideTooltip()
            }, t.prototype._addOutsideEventForHideTooltip = function () {
                var t = this;
                null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(), this._outsideEventForCollapsedTooltip = Object(b.a)(new CustomEvent("timestamp").timeStamp, this._collapsedDataSourcesWrapperEl, function () {
                    null !== t._outsideEventForCollapsedTooltip && t._outsideEventForCollapsedTooltip(), Object(j.hide)()
                ...
                if (null !== this._collapsedDataSourcesWrapperEl && null !== this._collapsedDataSourcesEl) {
                    var e = 0 === t;
                    this._collapsedDataSourcesWrapperEl.classList.toggle(m.blockHidden, e), e || (s(this._collapsedDataSourcesEl, "+" + t), this._collapsedDataSourcesEl.setAttribute("title", this._options.collapsedDataSourcesTitle.value()))
                }
                ...
                var t, e, i, s, o = this._showBackground.value(), n = this._themedColor.value(),
                    l = this._backgroundTransparency.value(), a = "";
                o && (e = (t = Object(d.parseRgb)(n))[0], i = t[1], s = t[2], a = Object(d.rgbaToString)([e, i, s, Object(d.normalizeAlphaComponent)(1 - l / 100)])), this._parentEl.style.color = a
            }, t.prototype._updateWrapText = function (t) {
                this._parentEl.classList.toggle(g.noWrap, !t)
            }, t
        }(), N = i("hY0g"), R = i.n(N), I = i("Tmoa"), F = i("aIyQ"), G = i.n(F), K = i("Ialn"), Z = i("QloM"), q = i("1AAW"), Y = i("CLNU"), U = window.t("Show"), J = window.t("Hide"), X = function () {
            function t(t, e, i, s) {
                var o = this;
                this._values = new R.a([]), this._actions = [], this._onDestroy = new G.a, this._moreActionCM = null, this._model = t, this._source = e, this._options = i, this._callbacks = s, this._disabled = new R.a(this._getDisabledState()), this._selected = new R.a(!1), this._isTitleHidden = new R.a(this._getTitleHiddenValue()), this._isValuesHidden = new R.a(this._getValuesHiddenValue()), this._isRowHidden = new R.a(this._getRowHiddenValue()), Object(q.a)(function () {
                    return {}
            ...
            return t.prototype.destroy = function () {
                ...
                this._model.setProperty(t, e, (e ? "Show" : "Hide") + " " + this._source.title()), a((e ? "Show" : "Hide") + " source")
            }, t.prototype.onShowSettings = function () {
                this._source.userEditEnabled() && (this.setSourceSelected(), this._callbacks.showChartPropertiesForSource(this._source, Z.TabNames.style), a("Settings for source"))
            }, t.prototype.onShowMoreActions = function (t) {
                return this._options.readOnlyMode ? Promise.resolve(null) : (this._callbacks.updateActions(), this._callbacks.showContextMenuForSources([this._source], this._calcNewPosition(t)))
            }, t.prototype.onContextMenuShow = function (t, e) {
                return this._options.readOnlyMode ? Promise.resolve(null) : (a("Show legend context menu"), this._callbacks.showLegendWidgetContextMenu(this._calcNewPosition(t), e))
                ...
                if (null !== o) for (t = o.getSplitTitle(), e = 0; e < this._titles.length; e++) i = t[e], s = Object(Y.clean)(Array.isArray(i) ? i.join(" ") : i || "", !0), this._titles[e].setValue(s)
            }, t.prototype._updateStates = function () {
                this._disabled.setValue(this._getDisabledState()), this._selected.setValue(this._model.selection().isSelected(this._source))
                ...
                }(t) && t.touches.length > 0 ? s = {
                    clientX: t.touches[0].clientX,
                    clientY: t.touches[0].clientY
                } : null !== t.target ? (e = t.target.getBoundingClientRect(), s = {
                    clientX: Object(K.isRtl)() ? e.right : e.left,
                    clientY: e.top + e.height + 3
                }) : s = {clientX: (i = t).clientX, clientY: i.clientY}, s
            }, t
        }(), Q = i("z4c1"), $ = i("vWJB"), tt = i("Kxc7"), et = !0, it = window.t("More"), st = window.t("Flag Symbol"), ot = window.t("Unflag Symbol"), nt = tt.enabled("show_hide_button_in_legend"), tt.enabled("marked_symbols"), lt = function (t) {
            function e(e, i, s, o) {
                var n, l, a = t.call(this, e, i, s, o) || this;
                for (a._titles = [new R.a(""), new R.a(""), new R.a(""), new R.a("")], a._symbolMarker = null, a._flagged = new R.a(null), a._symbolAction = null, a._symbol = null, a._createActions(), a._updateSymbolMarker(), a._model.model().properties().paneProperties.legendProperties.showSeriesTitle.subscribe(a, function () {
                    a._isTitleHidden.setValue(a._getTitleHiddenValue())
                }), n = 0, l = [a._model.model().properties().paneProperties.legendProperties.showSeriesOHLC, a._model.model().properties().paneProperties.legendProperties.showBarChange]; n < l.length; n++) l[n].subscribe(a, function () {
            ...
            return Object(r.__extends)(e, t), e.prototype.destroy = function () {
                ...
                }), this._values.setValue(t); else for (e = n.items(), i = 0; i < e.length; i++) s = e[i], l[i].value.setValue(s.value()), l[i].color.setValue(o(s.color())), l[i].visible.setValue(s.visible()), l[i].title.setValue(s.title())
            }, e.prototype._updateStates = function () {
                ...
                var t, e = this;
                et && this._options.symbolMarkerEnabled && (this._symbolAction = {
                ...
                }, this._actions.push(this._symbolAction)), nt && (t = {
                    icon: Q,
                ...
                }, this._actions.push(t), this._disabled.subscribe(function () {
        ...
        }(X), at = i("3ClC"), rt = i("oNDq"), dt = i("z61+"), ut = i("uOxu"), ht = i("RgOa"), ct = i("2CEX"), pt = i("D8x7"), Object(ut.getLogger)("Chart.LegendWidget"), _t = window.t("Settings"), bt = window.t("Show Source Code"), gt = window.t("Delete"), mt = window.t("More"), window.t("Error"), window.t("Could not get Pine source code."), tt.enabled("study_buttons_in_legend"), vt = tt.enabled("show_hide_button_in_legend"), wt = tt.enabled("property_pages"), yt = tt.enabled("format_button_in_legend"), ft = tt.enabled("delete_button_in_legend"), St = function (t) {
            function e(e, i, s, o) {
                var n = t.call(this, e, i, s, o) || this;
                return n._titles = [new R.a(""), new R.a("")], n._error = new R.a(!1), n._loading = new R.a(!1), n._isPineScriptDataSource = new R.a(!1), n._pineAction = null, n._globalVisibility = new R.a(!0), n._createActions(), n._model.model().properties().paneProperties.legendProperties.showStudyTitles.subscribe(n, function () {
                    n._isTitleHidden.setValue(n._getTitleHiddenValue())
                }), n._model.model().properties().paneProperties.legendProperties.showStudyValues.subscribe(n, function () {
                    n._isValuesHidden.setValue(n._getValuesHiddenValue())
                }), n.update(), n
            }

            return Object(r.__extends)(e, t), e.prototype.destroy = function () {
                t.prototype.destroy.call(this), this._model.model().properties().paneProperties.legendProperties.showStudyTitles.unsubscribeAll(this), this._model.model().properties().paneProperties.legendProperties.showStudyValues.unsubscribeAll(this), this._onDestroy.fire()
                ...
                var t;
                this._source.isUserDeletable() && (this._source.hasChildren() ? (t = this._model.removeSource.bind(this._model, this._source, !1), Object(rt.createConfirmDialog)({
                    type: "modal",
                ...
                var t, e, i, s, n, l, a = this._source.legendView();
                if (null !== a && 0 !== a.items().length) if (0 === (t = this._values.value()).length) e = a.items().map(function (t) {
                    return {value: new R.a(t.value()), color: new R.a(o(t.color())), visible: new R.a(t.visible())}
                }), this._values.setValue(e); else for (i = a.items(), s = 0; s < i.length; s++) n = t[s], l = i[s], n.value.setValue(l.value()), n.color.setValue(o(l.color())), n.visible.setValue(l.visible())
            }, e.prototype._updateStates = function () {
                t.prototype._updateStates.call(this), void 0 !== this._error && this._error.setValue(Boolean(this._source.isFailed())), void 0 !== this._loading && this._loading.setValue(Boolean(this._source.isLoading()))
            }, e.prototype._getTitleHiddenValue = function () {
                ...
                var t, e = this;
                this._options.readOnlyMode || (this._pineAction = {
                    icon: ct,
                    ...
                    t.title.setValue(e._getEyeTitle())
                })), wt && yt && (!Object(at.isStudy)(this._source) || new dt.MetaInfoHelper(this._source.metaInfo()).hasUserEditableOptions()) && this._actions.push({
                    icon: ht,
                    action: Object(_.b)(this.onShowSettings.bind(this)),
                    visible: new R.a(!0),
                    title: new R.a(_t),
                    dataset: {name: "legend-settings-action"}
                }), ft && this._actions.push({
                    icon: pt,
        ...
        }(X), Ct = i("EsvI"), Et = i("ogJP"), Vt = i("7KDR"), Mt = i("5VQP"), Tt = i("MXV9"), Ht = window.t("Show Symbol"), xt = window.t("Show OHLC Values"), At = window.t("Show Bar Change Values"), Lt = window.t("Show Indicator Titles"), Pt = window.t("Show Indicator Arguments"), Bt = window.t("Show Indicator Values"), kt = window.t("Wrap text"), Ot = v.CheckMobile.any(), Dt = i("PoSe"), zt = i.n(Dt), i("Vdly"), jt = i("PC8g"), i.d(e, "trackLegendEvent", function () {
            return a
            ...
            showToggleButton: !0,
            canShowSourceCode: !1
        }, tt.enabled("hide_legend_by_default"), Nt = tt.enabled("fundamental_widget"), Rt = tt.enabled("legend_context_menu"), It = .9, Ft = 2, Gt = function () {
            function t(t, e, i, s, o, n) {
                var l, a, d, u, h, c, p, _ = this;
                this._mainSeriesViewModel = null, this._dataSourceViewModels = [], this._visibleDataSourceCount = new R.a(0), this._themedColor = new R.a(""), this._mainSeriesRowHidden = null, this._dataSourceRowsHidden = [], this._allLegendHidden = new R.a(!1), this._studiesLegendHidden = new R.a(!1), this._onLegendVisibilityToggled = null, this._availableHeight = 0, this._collapsedDataSourcesCount = new R.a(0), this._collapsedDataSourcesTitle = new R.a(""), this._model = t, this._paneWidget = e, this._options = Object(Et.merge)(Object(Et.clone)(Wt), o), this._callbacks = Object(r.__assign)(Object(r.__assign)({}, n), {showLegendWidgetContextMenu: this.onShowLegendWidgetContextMenu.bind(this)}), this._mainSeriesViewModelsOptions = {
                    readOnlyMode: this._options.readOnlyMode,
                    symbolMarkerEnabled: this._options.symbolMarkerEnabled
                }, this._dataSourceViewModelsOptions = Object(r.__assign)(Object(r.__assign)({}, this._mainSeriesViewModelsOptions), {canShowSourceCode: this._options.canShowSourceCode}), this._backgroundThemeName = i, l = this._model.model().properties().paneProperties.legendProperties.showLegend,
                    this._isDataSourcesCollapsed = new R.a(l.value()), l.subscribe(this, function () {
                    _._isDataSourcesCollapsed.setValue(l.value())
                }), a = new R.a(this._getCustomTextColorValue()), this._model.model().properties().scalesProperties.textColor.subscribe(this, function () {
                    a.setValue(_._getCustomTextColorValue())
                }), d = this._model.model().properties().paneProperties.legendProperties.showBackground, u = new R.a(d.value()), d.subscribe(this, function () {
                    u.setValue(d.value())
                }), h = this._model.model().properties().paneProperties.legendProperties.backgroundTransparency, c = new R.a(h.value()), h.subscribe(this, function () {
                    c.setValue(h.value())
                }), p = this._model.model().properties().paneProperties.legendProperties.wrapText, this._wrapText = new R.a(p.value()), p.subscribe(this, function () {
                    _._wrapText.setValue(p.value()), _._updateCollapsedSourcesMode()
                }), this._hideNotMainSources = s.spawn(), this._hideNotMainSources.subscribe(this._updateVisibilityNotMainSources.bind(this)), this._isPaneMain = new R.a(this._getIsPaneMainValue()), this._updateCollapsedSourcesModeThrottle = zt()(this._updateCollapsedSourcesMode.bind(this), 100), this._renderer = new W({
            ...
            return t.prototype.destroy = function () {
                var t, e;
                for (this._hideNotMainSources.destroy(), null !== this._mainSeriesViewModel && this._mainSeriesViewModel.destroy(), t = 0, e = this._dataSourceViewModels; t < e.length; t++) e[t].destroy();
                this._clearVisibilitiesSubscriptions(), this._renderer.destroy(), delete this._renderer, this._model.model().properties().paneProperties.legendProperties.showLegend.unsubscribeAll(this), this._model.model().properties().scalesProperties.textColor.unsubscribeAll(this), this._model.model().properties().paneProperties.legendProperties.showBackground.unsubscribeAll(this), this._model.model().properties().paneProperties.legendProperties.backgroundTransparency.unsubscribeAll(this), this._model.model().properties().paneProperties.legendProperties.wrapText.unsubscribeAll(this)
            }, t.prototype.onShowLegendWidgetContextMenu = function (t, e) {
                return Rt ? l(this._model, this._options.contextMenu, this._callbacks.showGeneralChartProperties, t, e) : Promise.resolve(null)
            }, t.prototype.onCollapseDataSources = function () {
                var t = this._model.model().properties().paneProperties.legendProperties.showLegend;
                t.setValue(!t.value())
            }, t.prototype.updateLayout = function () {
                var t, e, i, s, o = this._paneWidget.state().orderedSources().filter(function (t) {
                    return null !== t.statusView()
                }), n = this._model.mainSeries(), l = o.indexOf(n);
                if (l > -1 ? (o.splice(l, 1), Nt || null !== this._mainSeriesViewModel || (this._mainSeriesViewModel = new lt(this._model, n, this._mainSeriesViewModelsOptions, this._callbacks), this._renderer.addMainDataSource(this._mainSeriesViewModel))) : null !== this._mainSeriesViewModel && (this._mainSeriesViewModel.destroy(), this._mainSeriesViewModel = null), t = [], 0 === (e = this._dataSourceViewModels.length)) for (i = o.length - 1; i >= 0; i--) t.push(new St(this._model, o[i], this._dataSourceViewModelsOptions, this._callbacks)); else {
                    for (s = 0, i = o.length - 1; i >= 0; i--) this._dataSourceViewModels[s] ? this._dataSourceViewModels[s].updateSource(o[i]) : t.push(new St(this._model, o[i], this._dataSourceViewModelsOptions, this._callbacks)), s++;
                    for (i = s; i < this._dataSourceViewModels.length; i++) this._dataSourceViewModels[i].destroy();
                    this._dataSourceViewModels.splice(s, this._dataSourceViewModels.length - s)
                }
                0 !== t.length && (this._renderer.addDataSources(t), this._dataSourceViewModels = this._dataSourceViewModels.concat(t)), e !== this._dataSourceViewModels.length && this._updateCollapsedSourcesMode(), this._recreateVisibilitiesSubscriptions(), this._isPaneMain.setValue(this._getIsPaneMainValue()), this.update()
            }, t.prototype.update = function () {
                var t, e;
                for (null !== this._mainSeriesViewModel && this._mainSeriesViewModel.update(), t = 0, e = this._dataSourceViewModels; t < e.length; t++) e[t].update()
            }, t.prototype.updateThemedColors = function (t) {
                null === t && (t = Object(Ct.getStdThemedValue)("chartProperties.paneProperties.background", this._backgroundThemeName.value())), this._themedColor.setValue(t || "")
                ...
                this._updateWidgetModeByWidth(t.w), this._updateWidgetModeByHeight(t.h)
                ...
                this._availableHeight = It * t, this._updateCollapsedSourcesModeThrottle()
            }, t.prototype._updateCollapsedSourcesMode = function () {
                var t, e, i, s, o, n, l, a, r, d = this._dataSourceViewModels.length;
                if (!this._wrapText.value() && this._availableHeight > 0 && d > Ft && (t = this._renderer.getMainSourceHeight(), e = this._renderer.getDataSourceHeight(), null !== t && null !== e && (i = Math.floor((this._availableHeight - t) / e), d > (s = Math.max(i, Ft) - 1) + 1))) {
                    for (o = "", n = 0; n < d; n++) l = n < s, this._dataSourceViewModels[n].setGlobalVisibility(l), l || (o += (0 === o.length ? "" : ", ") + this._dataSourceViewModels[n].getFullTitle());
                    return this._collapsedDataSourcesTitle.setValue(o), void this._collapsedDataSourcesCount.setValue(d - s)
                }
                for (a = 0, r = this._dataSourceViewModels; a < r.length; a++) r[a].setGlobalVisibility(!0);
                ...
                var t = this._model.model(), e = t.properties().scalesProperties.textColor.value()
                ;
                return t.isPropertyDefault("chartProperties.scalesProperties.textColor", e, Object(Ct.getCurrentTheme)().name) ? null : e
            }, t.prototype._clearVisibilitiesSubscriptions = function () {
                var t, e;
                for (null !== this._mainSeriesRowHidden && (this._mainSeriesRowHidden.destroy(), this._mainSeriesRowHidden = null), t = 0, e = this._dataSourceRowsHidden; t < e.length; t++) e[t].destroy();
                this._dataSourceRowsHidden = []
            }, t.prototype._recreateVisibilitiesSubscriptions = function () {
                var t, e, i, s, o, n;
                for (this._clearVisibilitiesSubscriptions(), null !== this._mainSeriesViewModel && (this._mainSeriesRowHidden = this._mainSeriesViewModel.isRowHidden().spawn(), this._mainSeriesRowHidden.subscribe(this._updateLegendVisibilities.bind(this))), t = 0, e = this._dataSourceViewModels; t < e.length; t++) i = e[t], this._dataSourceRowsHidden.push(i.isRowHidden().spawn());
                for (s = 0, o = this._dataSourceRowsHidden; s < o.length; s++) (n = o[s]).subscribe(this._updateVisibleDataSourceCount.bind(this)), n.subscribe(this._updateLegendVisibilities.bind(this));
                this._updateVisibleDataSourceCount(), this._updateLegendVisibilities()
            }, t.prototype._updateLegendVisibilities = function () {
                var t, e = this._dataSourceRowsHidden.every(function (t) {
                    return t.value()
                }), i = this._hideNotMainSources.value(), s = i || e;
                this._studiesLegendHidden.setValue(s), t = null === this._mainSeriesRowHidden || this._mainSeriesRowHidden.value(), this._allLegendHidden.setValue(e && t)
